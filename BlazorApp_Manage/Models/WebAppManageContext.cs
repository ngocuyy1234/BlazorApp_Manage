...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Device>(entity =>
        {
            ...
            entity.HasIndex(e => e.Macaddress, "UX_Devices_MACAddress_NotNull")
                .IsUnique()
                .HasFilter("([MACAddress] IS NOT NULL)");

            entity.HasIndex(e => e.Macaddress, "UX_Devices_MAC_Optional")
                .IsUnique()
                .HasFilter("([MACAddress] IS NOT NULL)");

            entity.HasIndex(e => e.SerialNumber, "UX_Devices_SN_Optional")
                .IsUnique()
                .HasFilter("([SerialNumber] IS NOT NULL)");

            entity.HasIndex(e => e.SerialNumber, "UX_Devices_SerialNumber_NotNull")
                .IsUnique()
                .HasFilter("([SerialNumber] IS NOT NULL)");

            entity.HasIndex(e => e.SerialNumber, "UX_Devices_SerialNumber_Optional")
                .IsUnique()
                .HasFilter("([SerialNumber] IS NOT NULL)");
        ...
        modelBuilder.Entity<NetworkConfig>(entity =>
        {
            ...
            entity.HasOne(d => d.Vlan).WithMany(p => p.NetworkConfigs)
                .HasForeignKey(d => d.Vlanid)
        ...
        modelBuilder.Entity<Port>(entity =>
        {
            ...
            entity.Property(e => e.ConnectedToDeviceId).HasColumnName("ConnectedToDeviceID");
            entity.Property(e => e.Description).HasMaxLength(200);
            entity.Property(e => e.DeviceId).HasColumnName("DeviceID");
            ...
            entity.HasOne(d => d.ConnectedToDevice).WithMany(p => p.PortConnectedToDevices)
                .HasForeignKey(d => d.ConnectedToDeviceId)
                .HasConstraintName("FK_Port_ConnectedDevice");

            entity.HasOne(d => d.Device).WithMany(p => p.PortDevices)
                .HasForeignKey(d => d.DeviceId)
                .HasConstraintName("FK_Port_Device");

            entity.HasOne(d => d.Vlan).WithMany(p => p.Ports)
                .HasForeignKey(d => d.Vlanid)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK_Port_VLAN");
        });
        ...
        modelBuilder.Entity<Vlan>(entity =>
        {
            ...
            entity.Property(e => e.Cidr).HasColumnName("CIDR");
            entity.Property(e => e.Description).HasMaxLength(200);
            entity.Property(e => e.GatewayIp)
                .HasMaxLength(45)
                .HasColumnName("GatewayIP");
            entity.Property(e => e.NetworkAddress).HasMaxLength(45);
